...
from .const import (
    ...
    CONF_PORT, DEFAULT_ANSWERING_MACHINE_EXTENSION, DEFAULT_HOST,
    DEFAULT_MAX_STORED_CALLS, DEFAULT_PORT, DOMAIN,
)

class CallMonitorTestConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
        ...
        schema = vol.Schema({
            ...
            vol.Required(
                ...
                default=(user_input or {}).get(
                    CONF_ANSWERING_MACHINE_EXTENSION, DEFAULT_ANSWERING_MACHINE_EXTENSION
                ),
            ): str,
            vol.Required(
                CONF_MAX_STORED_CALLS,
                default=(user_input or {}).get(CONF_MAX_STORED_CALLS, DEFAULT_MAX_STORED_CALLS),
